...
SELECT * FROM country c LEFT JOIN countrylanguage cl ON c.code = cl.countrycode WHERE cl.language = 'Italian' and c.region = 'Southern Europe';
--san marino
...
-- She's in _Santa Monica!!!_____________________!
